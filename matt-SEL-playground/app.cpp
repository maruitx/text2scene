...
void App::runTests()
{
	...
	debugText += "There is a queen size bed with two nightstands on each side. On each nightstand, there is a lamp. There is one dresser on the left side of the bed and a sofa chair is next to the dresser.";
	debugText += "There are four chairs around a round dining table. On the table, there are plates with food, a vase and a teapot. The table is messy.";
	debugText += "";
	debugText += "";
